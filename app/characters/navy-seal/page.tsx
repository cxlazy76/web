...
export default function NavySealPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const res = await fetch(API_URL, {
        ...
        body: JSON.stringify({ name, surname, character: 'navyseal' }),
      });
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      link.href = blobUrl;
      link.download = 'NavySeal_Message.mp4';
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col justify-center items-start w-full md:w-1/2 space-y-4 text-left">
          ...
          >
            {loading ? 'Generating...' : 'Generate My Navy Seal Video'}
          </button>
